...
public class PlaylistActivity extends FragmentActivity implements
	...
	public static class DummySectionFragment extends Fragment {
		...
		private String TAG = "DummySectionFragment";
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			*/
			...
			//Log.d(TAG, Integer.toString(getArguments().getInt(ARG_SECTION_NUMBER)));
